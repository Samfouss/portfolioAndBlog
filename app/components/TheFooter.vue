      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <p class="text-gray-400">
            Exploring the intersection of data science and bioinformatics to
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <NuxtLink to="/#overview" class="footer-link">About</NuxtLink>
            </li>
            <li>
        ...
        <div>
          <h3 class="text-lg font-semibold mb-4 text-gray-300">Connect</h3>
          <div class="flex space-x-4">
            <a href="https://github.com/Samfouss" class="footer-social" target="_blank" rel="noopener noreferrer">
            ...
            <a
              href="https://www.linkedin.com/in/fousseni-sama/"
              class="footer-social"
              target="_blank"
