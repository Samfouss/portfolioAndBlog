  ...
  <header class="bg-gray-900">
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        <!-- Left: Name/Logo -->
        <NuxtLink to="/" class="text-xl font-medium text-gray-300">
          Emadalmagedy
        </NuxtLink>
        ...
        <div class="flex items-center">
          <a href="https://github.com/Samfouss" target="_blank" rel="noopener noreferrer" class="text-white hover:text-gray-300 transition-colors duration-200">
...
.nav-link-mobile {
  @apply block px-4 py-2 text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition-colors duration-200;
}
